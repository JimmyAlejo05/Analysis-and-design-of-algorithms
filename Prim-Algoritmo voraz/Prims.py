...
##     EN PYTHON ES MUY FaCIL CREAR LISTAS Y DICCIONARIOS NECESARIOS
...
while listaOrdenada:
  ...
  if d not in listaVisitados:
    ...
    # ES UNA TUPLA QUE CONTIENE TRES VALORES; EL VERTICE EN SU POSICIoN 0 ES EL VALOR DEL NODO ORIGEN
    # EL VeRTICE EN SU POSICIoN 1 ES EL NODO DESTINO, Y EL VeRTICE EN SU POSICIoN 2 ES EL PESO DE LA ARISTA ENTRE AMBOS NODOS,
    # Y A CONTINUACIoN SE AGREGAN ESOS VALORES AL GRAFO
    origen  = vertice[0]
    destino = vertice[1]
    peso    = vertice[2]
